...
class FoodInfo(object):
    def __init__(self, term_code, term_extended_name, scientific_names, all_facets, part_info, process_info, ingred_info, packformat_info):
        ...
        self.term_extended_name = term_extended_name
    ...
    def __str__(self):
        print_message = "FoodInfo:\n          term_code = %s\n          term_extended_name = %s\n          scientific_names = %s\n          all_facets = %s\n          %s\n          %s\n          %s\n          %s" % (self.term_code, self.term_extended_name, self.scientific_names, self.all_facets, self.part_info, self.process_info, self.ingred_info, self.packformat_info)
        return print_message
