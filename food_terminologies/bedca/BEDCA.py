...
class Food(FoodTerm):
    def __init__(self, id_food, nombre_es, nombre_en, langual_code, edible_part, group):
        self.food_term = FoodTerm(id_food, nombre_es, nombre_en, group)
        self.langual_code = langual_code
        self.edible_part = edible_part
  
    def __str__(self):
        print_message = "Food:\n                              id_food = %s\n                              nombre_es = %s\n                              nombre_en = %s\n                              langual_code = %s\n                              edible_part = %s\n                              %s" % (self.food_term.id_food, self.food_term.name_es, self.food_term.name_en, self.langual_code, self.edible_part, self.food_term.id_group)
        return print_message
